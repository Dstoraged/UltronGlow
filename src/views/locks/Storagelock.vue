          ...
          <div class="col-md-4">
            <div class="input-group" style="margin: 0 auto">
              <input
                type="text"
                class="form-control"
                :placeholder="$t('lock.minerSearch')"
                id="demo"
                v-model="searchInput"
          ...
          <table class="table table-hover mb-0">
            ...
            <tbody>
              <tr v-for="(item, index) in blockList" :key="index">
                ...
                <td>{{ scope.row.lockingTime }} {{ $t("lock.day") }}</td>
              </tr>
            </tbody>
          </table>
        </div>
              ...
              <li class="page-item">
                <a
                  ...
                  style="
                    ...
                    color: #41c0cb;
                  "
                  @click="getStoragelockList(page - 1)"
              ...
              <li class="page-item">
                <a
                  ...
                  style="
                    ...
                    color: #41c0cb;
                  "
                  @click="getStoragelockList(totalPages)"
                  >{{ $t("pagination.last") }}</a
                >
              </li>
            </ul>
...
export default {
  ...
  mounted() {
    ...
    this.getStoragelockList(this.page);
  },
    ...
    toRelease(data) {
      if (data.address && data.type) {
        helper.goPathUrl(
          this,
          "releaseList",
          `${data.address}_${data.type + 1}_${data.blockNumber}`
        );
      }
    },
