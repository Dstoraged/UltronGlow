      ...
      <div class="card-body" style="text-align: left">
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            <tbody>
              <tr>
                <td style="min-width: 100px">{{ $t("trandetail.From") }}</td>
                <td>
                  <span
              ...
              <tr>
                <td style="min-width: 100px">{{ $t("trandetail.to") }}</td>
                <td>
                  <span
                    class="cursor forcibly-blue equal-width"
              ...
              <tr>
                ...
                <td>{{ getDataFormat(tranInfo.amount).toFixed(4) }} UTG</td>
              </tr>
              <tr>
                <td style="min-width: 100px">
              ...
              <tr>
                ...
                <td>
                  {{ getDataFormat(tranInfo.gasPrice, 9).toFixed(4) }} Gwei
                </td>
              </tr>
...
export default {
  ...
  created() {
    if (this.$route.params.transHash == undefined && getValue("tran") != "") {
      this.tranAddr = JSON.parse(getValue("tran")).transHash;
      this.symbol = JSON.parse(getValue("tran")).symbol;
    } else {
      this.tranAddr = this.$route.params.transHash;
  ...
  methods: {
    ...
    getTranInfo() {
      ...
      api
        .post("/platform/getTransactionByTokenHashInfo ", param)
        .then((response) => {
          if (response.statusCode !== 0) {
            Message.error(response.message);
          } else {
