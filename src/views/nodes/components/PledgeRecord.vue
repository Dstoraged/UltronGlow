<template>
  <div>
    ...
    <h-tbale ref="htableNodePledgeList" :table-heard="nodePledgeListTableHeard" :table-data="nodePledgeListtableData"
      :show-right-tools="false" :tableId="'PledgeRecordtableId' + node_addr" :showSubtitle="false"
      @inint-ok="tableInitnodePledgeList" @load="loadTablenodePledgeList" @colClick="colClick">
