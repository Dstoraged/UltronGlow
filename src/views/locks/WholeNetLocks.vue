      ...
      <div class="card-body">
        ...
        <div class="row" style="text-align: left; margin: 0px; padding: 0px">
          <div class="col-md-12" style="padding: 0px; margin: 0px">
            <p class="sub-title" style="width: 100%; text-align: left; margin-bottom: 8px">
        ...
        <h-tbale ref="htableWholeNetLocks" :table-heard="tableHeard" :table-data="tableData" :show-right-tools="false"
          :showSubtitle="false" :up-load-time="30000" table-id="WholeNetLocksTableId" @inint-ok="tableInit"
          @load="loadTable" @colClick="colClick">
          <div class="btn-group" slot="table_title_right_address" slot-scope="scope" v-if="scope.type == 'pc'">
            ...
            <div :id="`lvbNodeAddress_${scope.type}`" style="
                display: none;
                position: absolute;
                z-index: 999999;
                left: 0;
              ...
              <div>
                <div class="form-group row">
                  <div class="col-sm-12">
                    <input type="text" class="form-control" id="demo" v-model="searchInput" style="width: 100%" />
                  </div>
                </div>
                <div class="popover-footer" style="text-align: center">
                  <button type="button" class="btn btn-primary btn-sm" @click="bntNodeAddressFilter(scope.type)">
                    <i class="fa fa-filter"></i>{{ $t("comm.filter") }}
                  </button>
                  <button type="button" class="btn btn-primary btn-sm" @click="bntNodeAddressClear(scope.type)">
...
export default {
  ...
  methods: {
    ...
    async loadTable(query, toTop = true, pageNum) {
      ...
      if (!query && this.$refs.htableWholeNetLocks) {
        query = this.$refs.htableWholeNetLocks.tableQuery;
      }
