<template>
  <div class="container-fluid">
    <h-tbale ref="contractTranhtable" :table-heard="tableHeard" :table-data="tableData" :show-right-tools="false"
      :showSubtitle="true" :up-load-time="30000" :table-id="'ContractTranTableId' + contract" @inint-ok="tableInit"
...
export default {
  ...
  methods: {
    ...
    loadTable(query, toTop = true, pageNum) {
      if (!query && this.$refs.contractTranhtable) {
        query = this.$refs.contractTranhtable.tableQuery;
      }
