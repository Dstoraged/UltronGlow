  ...
  <div class="container-fluid">
    <div class="card" style="margin-top: 40px">
      <div class="card-body">
        ...
        <h-tbale ref="transferTable" :table-heard="tableTransferHeard" :table-data="tableData" :show-right-tools="false"
          :tableId="'TransferRecord' + fromAddr + toAddr" :showSubtitle="false" @colClick="colClick">
...
export default {
  ...
  methods: {
    ...
    loadTable(query, toTop = true, pageNum) {
      if (!query && this.$refs.transferTable) {
        query = this.$refs.transferTable.tableQuery;
      }
