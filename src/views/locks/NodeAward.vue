  ...
  <div class="container-fluid">
    <div class="card" style="margin-top: 40px">
      <div class="card-body">
        ...
        <h-tbale ref="htableNodeAward" :table-heard="tableHeard" :table-data="tableData" :show-right-tools="false"
          :showSubtitle="false" :up-load-time="30000" table-id="NodeAwardTableId" @inint-ok="tableInit"
    ...
    return {
      tableHeard: [
        ...
        },
        {
          ...
          name: "releaseamount",
          valMap(val) {
            //console.log("releaseamount="+val,utils.clearZero(val))
 ...
 */
  ...
  methods: {
    ...
    async loadTable(query, toTop = true, pageNum) {
      ...
      if (!query && this.$refs.htableNodeAward) {
        query = this.$refs.htableNodeAward.tableQuery;
      }
      ...
      api
        ...
        .then((response) => {
          ...
          this.tableData.forEach((item, index) => {
            if (item.pledgeAddress === null || item.pledgeAddress == 'ux0000000000000000000000000000000000000000') {
              item.address = item.address;
            } else {
              item.address = item.pledgeAddress;
            }
          })
