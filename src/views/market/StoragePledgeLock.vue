  ...
  <div class="container-fluid">
    <div class="card" style="margin-top: 40px">
      <div class="card-body">
        ...
        <h-tbale
          ref="htableStoragePledgeLock"
          :table-heard="tableHeard"
          :table-data="tableData"
          :show-right-tools="false"
          :showSubtitle="false"
          :up-load-time="30000"
          table-id="StoragePledgeLockTableId"
          @inint-ok="tableInit"
          @load="loadTable"
          @colClick="colClick"
        >
...
export default {
  ...
  methods: {
    ...
    async loadTable(query, toTop = true, pageNum) {      
      if (!query && this.$refs.htableStoragePledgeLock) {
        query = this.$refs.htableStoragePledgeLock.tableQuery;
      }
