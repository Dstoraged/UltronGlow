  ...
  <div class="container-fluid">
    <div class="card" style="margin-top: 40px">
      <div class="card-body">
        <div class="row" style="padding: 6px; text-align: left">
          <div class="col-md-4">
            ...
            <p class="sub-title" style="width: 100%; text-align: left">
              {{ $t("token.current721Number", [total]) }}
            </p>
          </div>
          <div class="col-md-4">
        ...
        <h-tbale ref="htableViewTokennft" :table-heard="tableHeard" :table-data="tableData" :show-right-tools="false"
          tableId="ViewTokennfttableId" :showSubtitle="false" @inint-ok="tableInit" @load="loadTable"
          @colClick="colClick">
        </h-tbale>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    loadTable(query, toTop = true, pageNum) {
      if (!query && this.$refs.htableViewTokennft) {
        query = this.$refs.htableViewTokennft.tableQuery;
      }
      if (!query) return;
