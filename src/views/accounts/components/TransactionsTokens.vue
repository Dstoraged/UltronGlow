...
export default {
  ...
  methods: {
    ...
    loadTable(query, toTop = true, pageNum) {
      if (!query && this.$refs.htableTokenTransfersERC20) {
        query = this.$refs.htableTokenTransfersERC20.tableQuery;
      }

      if (!query||!this.accAddr) return;
      ...
      api
        ...
        .then((response) => {
          ...
          this.$emit("tabSwhitch",this.tokenType,!!this.total);
