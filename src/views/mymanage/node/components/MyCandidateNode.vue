<template>
  <div class="container-fluid">
    ...
    <h-tbale ref="candidateNodeTable" :table-heard="candidateNodetableHeard" :table-data="candidateNodetableData"
      :show-right-tools="true" :tableId="'CandidateNodetableId' + this.$store.getters.account" :showSubtitle="false"
      @inint-ok="tableInitcandidateNode" @load="loadTablecandidateNode" @colClick="colClick">
  ...
  methods: {
    ...
    loadTablecandidateNode(query, toTop = true, pageNum) {
      ...
      api.postJson("/platform/node/getcadnodelist", param).then((response) => {
        ...
        this.candidateNodetableData = newData;
    ...
    seachCandidateData(val) {
      this.tableInitcandidateNode(null, 1);
    },
