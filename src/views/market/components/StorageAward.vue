      ...
      <table class="table table-hover mb-0">
        ...
        <tbody>
          <tr v-for="(item, index) in blockList" :key="index">
            ...
            <td>
              <span>{{ scope.row.lockingTime }} {{ $t("lock.day") }}</span>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <li class="page-item">
            <a
              ...
              style="
                ...
                color: #41c0cb;
              "
              @click="getStorageAwardList(page - 1)"
            >
          ...
          <li class="page-item">
            <a
              ...
              style="
                ...
                color: #41c0cb;
              "
              @click="getStorageAwardList(totalPages)"
              >{{ $t("pagination.last") }}</a
            >
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      this.getStorageAwardList(this.page);
    },

    async getStorageAwardList(page) {
      showLoading();
