<template>
  <div :class="hasGlobalDialog() ? 'active' : ''" class="app-dialog">
          ...
          <el-form ref="loginForm" :model="loginForm">
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('login.account_email_placehold')"
              />
            </el-form-item>
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('login.password_placehold')"
                type="password"
              />
            </el-form-item>
          ...
          <el-form ref="registerForm" :model="registerForm">
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('register.account_email_placehold')"
              />
            </el-form-item>
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('register.validate_code_placehold')"
              >
                <el-button
                  slot="append"
                  type="text"
                  @click="handleGetValidateCode()"
                >
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('register.password_placehold')"
                type="password"
              />
            </el-form-item>
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('register.repassword_placehold')"
                type="password"
              />
            </el-form-item>
    ...
    <el-dialog
      :visible.sync="$parent.forgetPasswordFlag"
          ...
          <el-form ref="forgetPasswordForm" :model="forgetPasswordForm">
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('forget_password.account_email_placehold')"
              />
            </el-form-item>

            <el-form-item>
              <el-input
                v-model="forgetPasswordForm.validateCode"
                :placeholder="$t('forget_password.validate_code_placehold')"
              >
                <el-button
                  slot="append"
                  type="text"
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('forget_password.password_placehold')"
                type="password"
              />
            </el-form-item>
            ...
            <el-form-item>
              <el-input
                ...
                :placeholder="$t('forget_password.repassword_placehold')"
                type="password"
              />
            </el-form-item>
            ...
            <el-form-item>
              <el-button
                ...
                class="sign-in"
                type="primary"
                @click="handleGetbackPassword()"
                >{{ $t("forget_password.confirm") }}</el-button
              >
            </el-form-item>
          </el-form>
        </div>
    ...
    <el-dialog
      :visible.sync="$parent.supplementInformationFlag"
      class="supplement-information-dialog"
    >
    ...
    <el-dialog
      :visible.sync="$parent.commonErrorFlag"
      ...
      <div class="common-error-dialog-content">
        ...
        <div class="button-wrapper">
          <el-button
            :round="true"
            type="primary"
            @click="handleConfirmCommonError()"
          >
    ...
    <el-dialog
      :visible.sync="$parent.commonDeleteFlag"
      class="common-delete-dialog"
    >
      <div class="common-delete-dialog-content">
        ...
        <div class="button-wrapper">
          <el-button
            :round="true"
            type="primary"
            @click="handleConfirmCommonDelete()"
          >
            {{ $parent.commonConfirmButtonText }}
          </el-button>
...
export default {
  ...
  methods: {
    ...
    hasGlobalDialog() {
      return (
        this.$parent.loginFlag ||
        this.$parent.registerFlag ||
        this.$parent.forgetPasswordFlag ||
        this.$parent.supplementInformationFlag ||
        this.$parent.commonErrorFlag ||
        this.$parent.commonDeleteFlag
      );
    },
          ...
          this.$store
            ...
            .then((response) => {
              ...
              if (response.Status === 1) {
                ...
                const supplementInformationFlag =
                  this.$parent.isSupplementComplete;
