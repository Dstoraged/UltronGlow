  ...
  <div class="container-fluid">
    <div class="card" style="margin-top: 40px">
      <div class="card-body">
        <div class="row" style="padding: 6px; text-align: left">
          <div class="col-md-4">
            <h4 class="mt-0 header-title" style="width: 100%; text-align: left">
              Multi-Token {{ $t("token.title1155") }}
            </h4>
            <p class="sub-title" style="width: 100%; text-align: left">
              {{ $t("token.current1155Number", [total]) }}
            </p>
          </div>
          <div class="col-md-4">
        ...
        <h-tbale ref="htableViewTokennft1155" :table-heard="tableHeard" :table-data="tableData"
          :show-right-tools="false" tableId="ViewTokennft1155tableId" :showSubtitle="false" @inint-ok="tableInit"
...
export default {
  ...
  methods: {
    ...
    loadTable(query, toTop = true, pageNum) {
      if (!query && this.$refs.htableViewTokennft1155) {
        query = this.$refs.htableViewTokennft1155.tableQuery;
      }
      if (!query) return;
